...
<div class="ui-tabs ui-cmp-bars">
    <ul>
        ...
        <li class="<?=!isset($tab) || $tab == $seo_name["page"]["newfeed"] || $tab == $seo_name["page"]["vi"]["newfeed"] ? "current" : ''?>"><a href="/<?=$urlCmp?>/<?=$seo_name["page"]["vi"]["newfeed"]?>" ><?=$language["newfeed"]?></a></li>
        <li class="<?=isset($tab) ? ($tab == $seo_name["page"]["about"] || $tab == $seo_name["page"]["vi"]["about"] ? "current" : '') : ''?>"><a href="/<?=$urlCmp?>/<?=$seo_name["page"]["vi"]["about"]?>" ><?=$language["about"]?></a></li>
        <li class="<?=isset($tab) ? ($tab == $seo_name["page"]["photo"] || $tab == $seo_name["page"]["vi"]["photo"] ? "current" : '') : ''?>"><a href="/<?=$urlCmp?>/<?=$seo_name["page"]["vi"]["photo"]?>" ><?=$language["photos"]?></a></li>
        <li class="<?=isset($tab) ? ($tab == $seo_name["page"]["jobs"] || $tab == $seo_name["page"]["vi"]["jobs"] ? "current" : '') : ''?>"><a href="/<?=$urlCmp?>/<?=$seo_name["page"]["vi"]["jobs"]?>" ><?=$language["companyJob"]?></a></li>
        <?php else:?>
        <li class="<?=isset($tab) ? ($tab == $seo_name["page"]["about"] || $tab == $seo_name["page"]["vi"]["about"] ? "current" : '') : ''?>"><a href="/<?=$urlCmp?>/<?=$seo_name["page"]["vi"]["about"]?>" ><?=$language["about"]?></a></li>
        <li class="<?=isset($tab) ? ($tab == $seo_name["page"]["jobs"] || $tab == $seo_name["page"]["vi"]["jobs"] ? "current" : '') : ''?>"><a href="/<?=$urlCmp?>/<?=$seo_name["page"]["vi"]["jobs"]?>" ><?=$language["companyJob"]?></a></li>
        <?php endif;?> 
