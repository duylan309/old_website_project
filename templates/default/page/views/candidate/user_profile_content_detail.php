<div class="w-b b-r-4 p-20 cmp-more">
    <div class="row">
            ...
            <div class="row p-10">
                <div class="col-sm-3 col-xs-2">
                    <div class="cmp-logo text-center">
                        <?php
                        $strImg = UDATAIMAGE."style/user.png";
        ...
        <div class="col-sm-4 text-right">
            ...
            <?php if($isCandidateOfUser):?>
            <a href="#" data-btn-send-message
                class="btn-xs"
                data-button-magic
                data-elm-data='{"db": { "employer_id" : "<?=$sessionUserId?>","company_id"  : "", "user_id" : "<?=$infoUser["id"]?>", "sender_id" : "<?=$sessionUserId?>", "receiver_id" : "<?=$infoUser["id"]?>", "user_name" : "<?=$infoUser["name"]?>", "user_image" : "<?=$infoUser["im"] ? $infoUser["im"] : ''?>" } }'
    ...
    <div class="cmp-more">
        <div class="row">
            <div class="col-sm-3 text-left">
                <label><?=$language["reviewcomment"]?></label>
            </div>
            <div class="col-sm-9">
                <div class="item-view-comment"
                     data-view-list-by-handlebar
                     data-init-button-magic="[comment-row] [data-button-magic]"
                     data-url="<?=APIGETCOMMENT?>/<?=$sessionUserId?>?uid=<?=$infoUser["id"]?>&action=view"
                     data-method="get"
                     data-show-page="10"
                     data-show-item="20"
                     data-show-all="false"
                ...
                <div class="comment-form">
                    <form method="post" class="form-horizontal post-form">
                        <div class="hidden">
                            <input name="db.uid" type="text" value="<?=$infoUser["id"]?>">
                            <input name="db.eid" type="text" value="<?=$sessionUserId?>">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <textarea   name="db.content"
                                                    data-validate
                                                    data-message
                                                    placeholder="<?=$language["typeacomment"]?>"
                                                    data-required="<?=$language["require"]?>"
                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    <button class="bg-color1 btn"
                                            ...
                                            data-redirect="."
                                            value="<?=$language["btnPost"]?>"><span><?=$language["btnPost"]?></span>
                                    </button>
                                </div>
                                <div class="col-xs-5 text-right">
                                    <label><?=$language["sendCommentAs"]?></label>
                                </div>
                                <div class="col-xs-4">
                                    <div class="form-group">
                                    <div class="company-list no-margin"
                                            data-copy-template
                                            data-elm-data='{"company_id":""}'
