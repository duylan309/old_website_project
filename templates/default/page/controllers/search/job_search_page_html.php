...
$web_title = isset($information["meta"]["title"][$_SESSION["lang"]]) && !is_array($information["meta"]["title"][$_SESSION["lang"]]) ? $information["meta"]["title"][$_SESSION["lang"]] : '';
...
function main() {
    ...
    $catOption        = $getParams["ca"] ? intval($getParams["ca"]) : array();
    ...
    $paramUrl = "&random=1&var=window.viewSearchJobs";
