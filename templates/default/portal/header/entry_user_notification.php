...
<li class="<?=$message["status"] != 0 ? "item-read" : ""?> ">
    <div class="row">
        <div class="col-sm-2">
            <img class="thumb_img" alt="<?=$message["company_name"]?>" src="<?=isset($message['company_image']) && !empty($message['company_image'])? '/'.FOLDERIMAGECOMPANY.'thumbnail/'.$message['company_image'] : UDATAIMAGE."style/user.png"?>">
        </div>
        <div class="col-sm-10">
...
<li class="<?=$message["status"] != 0 ? "item-read" : ""?> ">
    <div class="row">
        <div class="col-sm-2">
            <img class="thumb_img" alt="<?=$message["user_name"]?>" src="<?=isset($message['user_image']) && !empty($message['user_image'])? '/'.FOLDERIMAGEUSER.$message['user_image'] : UDATAIMAGE."style/user.png"?>">
        </div>
        <div class="col-sm-10">
            <a href="/<?=$seo_name["page"]["user"]."?manage=messages&action=view&mid=".$message["id"]?>">
