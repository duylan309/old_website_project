            ...
            <form method="post" class="post-form" data-hidden-info-from-ajax>
                ...
                <div class="form-group m-b-5" >
                    <input type="text"
                       ...
                       data-pattern-message="{{d.l10n.requireEmailRule}}"
                       placeholder="{{d.l10n.email}}"
                       data-compare="#accountEmailConfirm"
                ...
                <div class="form-group m-b-5" >
                    <input type="text"
                       ...
                       data-pattern="^[\w._%+-]{2,}@[\w.-]{1,}\.[\w]{2,}$"
                       data-pattern-message="{{d.l10n.requireEmailRule}}"
                       placeholder="{{d.l10n.confirmEmail}}"
                       data-compare="#accountEmailConfirm"
                       data-compare-message="{{d.l10n.matchEmail}}"
                       id="accountEmailConfirm"
                       class="form-control">
...
<script id="entryFormSignup" type="text/x-handlebars-template">
    <form method="post" autocomplete="off" class="form-horizontal post-form post-form-signup" data-hidden-info-from-ajax>
        ...
        <div class="fieldset bg-color4 p-10 m-b-20">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text"
                       ...
                       id="accountEmailConfirm">
                    <span class="error"></span>
                    <div class="text-color2 t-s-11">{{d.l10n.emailLogin}}</div>
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-3">{{d.l10n.confirmEmail}}</label>
                <div class="col-sm-9">
                    <input type="text"
                       name="email"
                       class="form-control"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-offset-3 col-sm-9">
                  <button type="submit"
                     ...
                     data-element-value-input="[data-value-input]"
                     data-show-hide=".signup-info-review,[data-hidden-info-from-ajax]"
                     class="btn bg-color3 m-t-15 btn-block text-uppercase"
                ...
                <div class="tab-content no-padding">
                  ...
                  <form method="post" data-upload-image="[name='db.im']" enctype="multipart/form-data" class="post-form post-form-apply">
                    ...
                    <div class="cmp-more no-m-top facebook-fill-personal-profile">
                      ...
                      <div class="form-group">
                        <div class="row">
                          <label class="col-sm-3">{{d.l10n.confirmEmail}} <span class="require">*</span></label>
                          <div class="col-sm-9">
                             <input type="text"
                                name="db.email"
                                class="form-control input-sm"
