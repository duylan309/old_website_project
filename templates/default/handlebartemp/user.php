        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="title text-center">
                    <a href="/{{d.l10n.employerlink}}" class="text-color3 no-margin text-uppercase t-s-12 text-bold text-underline"> {{d.l10n.help}}</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="password"
                                            ...
                                            data-required="{{d.l10n.require}}"
                                            data-compare="#accountPasswordNew"
                                            data-compare-message="{{d.l10n.matchEmail}}"
                                            id="accountPasswordConfirm"
                                            class="form-control">
                                        <span class="error"></span>
                                    </div>
...
<div class="block transition">
    <div class="block-title bg-color1 text-uppercase text-bold">
        ...
        <div class="p-10">
            <div class="pm-3">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2"><button class="btn bg-color3 text-bold f-s-17 w-100">{{d.l10n.btnFinish}}</button></div>
                </div>
                        ...
                        <div class="cmp-more">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class="error"></span>
                                    <label class="text-color3 t-s-11">{{d.l10n.warningEmail}}</label>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <input  type="text"
                                ...
                                placeholder="{{d.l10n.exampleThueUrl}}"
                                data-min-length="6"
                                data-pattern="^((?![/,\,<,>,[ ]).)*$"
                                {{#if i.db.id}}
