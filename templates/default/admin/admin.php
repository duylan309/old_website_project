...
function main() {
    ...
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAsDxYLtt1WGS-_BkdFZlg5CboNuLWhcYw">
                ...
                } elseif($titlePage == "extension") {
                    # view List
                    $strAjaxUrl = APIGETADMINUPDATEDAYS."?action=lists&from={$intFrom}&to={$intTo}";
                    $strGetScript = '<script src="'.$strAjaxUrl.'&var=window.adminPageExtension"></script>';
                    
                    $functionTemplate = "entryManagePageExtension";
