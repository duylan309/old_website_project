...
<div class="item-content" data-google-map-in-tab="google-map-profile">
    ...
    <div class="tab-content">
        ...
        <!-- <div class="user-update-more user-update-more2 no-m-top "
            data-copy-template
            data-option-local="companyInfomation"
            data-elm-data='{"triggerClick":".user-update-more2 [data-closet-toggle-class]"}'
            data-view-template=".user-update-more2"
            data-template-id="entryCmpUpdateMoreWorkUs">&nbsp;</div> -->
        ...
        <?php if(isset($companyInfoPage["more"]["about"]) && count($companyInfoPage["more"]["about"])):?>
        <div class="cmp-more">
            <div class="row">
               
                <div class="col-sm-12 textarea-content-line">
                    <?=isset($companyInfoPage["more"]["about"]) && count($companyInfoPage["more"]["about"]) ? mysql_unreal_escape_string($companyInfoPage["more"]["about"]) : '' ?>
                </div>
            </div>
        </div>
        <?php endif;?>
