...
<div class="message-inbox">
    <div class="item-view-contact-list admin-list"
        ...
        data-show-page="6"
        data-show-item="30"
        data-elm-data='{"imagefolder":"<?=FOLDERIMAGEUSER?>","type":"<?=$_SESSION["userlog"]["type"]?>","action":"favorite"}'
        data-show-all="false"
        ...
        <div class="row admin-title">
            <div class="col-sm-12">
                <h2 class="pull-left text-color1 no-margin"><?=$language["favoritemessages"]?></h2>
            </div>
        </div>
        ...
        <table table-message-inbox class="table table-bordered">
            ...
            <thead>
                <tr class="b-b">
                    ...
                    <th size-action class="col-sm-1"></th>
                    <th class="col-sm-3"><?=$language["candidates"]?></th>
                    <th class="col-sm-5"><?=$language["content"]?></th>
