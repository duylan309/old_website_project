...
<div class="row m-t-15">
            ...
            <form class="post-form filter-form" data-change-to-submit-form data-search-form action="/<?=$seo_name["page"]["search"]?>">
                <div class="filter bg-color4">
                    ...
                    <div class="form-group p-10 p-b-0">
                        ...
                        <input type="hidden" data-order name="order" value="<?=isset($_GET["order"]) ? intval($_GET["order"]) : 1?>">
                        <input type="hidden" name="brand" value="view">
                ...
                <a class="btn btn-block bg-color5" href="<?="http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"."&map=view"?>">
    ...
    <div class="col-sm-9">
        ...
        <div class="item-view-more job-list-result job-list-brand m-t-15"
            data-view-list-by-handlebar
            data-init-button-magic=".item [data-button-magic]"
            ...
            data-template-id="viewItemJobSearchBrand" >
