<div class="hidden">
    <script src="<?=$getUrl.$paramUrl?>&var=window.viewSearchJobs"></script>
</div>
            ...
            <form class="post-form filter-form" data-change-to-submit-form action="/<?=$seo_name["page"]["search"]?>">
                <div class="filter bg-color4">
                    ...
                    <div class="form-group p-10 p-b-0">
                        ...
                        name="title"
                        value="<?=isset($getParams["subject"]) && count($getParams["subject"]) ? $getParams["subject"]:null; ?>"
