...
<div class="item-view-more admin-list"
    ...
    data-template-id="entryProductItem" >
    <div class="admin-title">
        <div class="row">
            <div class="col-xs-5">
                <h2><?=$language["productManage"]?></h2>
            </div>
            <div class="col-xs-5">
            ...
            <div class="col-xs-2 text-right">
                ...
                data-template-id="entryProductAdd"><?=$language["add"];?> + </button>
            </div>
        </div>
    </div>
    <div class="head-title">
        <div class="row">
            ...
            <div class="col-xs-2"><label><?=$language["price"]?></label></div>
                ...
                <div class="col-xs-2">
                    <div class="form-group">
                        <select name="st"
                            data-dropdown
                            data-object-init='{"id":"", "ti":"<?=$language["viewAll"]?>"}'
                            data-option-local-json="productStatus"
                            data-compare="equal"
