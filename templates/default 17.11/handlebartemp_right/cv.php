    ...
    <div class="row">
        <div thumbnail-user class="col-xs-3 col-sm-1">
            <div class="img i-center pr-div b-cover b-r-4 m-b-5">
                <figure>
                    <a {{#if e.linkMore}}
                            href="{{e.linkMore}}cid={{i.db.id}}&uname={{i.db.name}}"
                        {{else}}
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="view-action">
                        <span class="text-cap">{{d.l10n.jobApplied}}: <a class="text-color3 text-bold" href="/<?=$seo_name["page"]["job"]?>/{{{urlFriendly i.jt i.ji}}}">{{i.t}}</a></strong>
                    </div>
                    {{/if}}
...
<div class="cmp-more">
    ...
    <div class="j-view-option row">
        ...
        <p class="textarea-content col-xs-12 col-sm-9">{{#if i.userinfo.db.about}}{{i.user_cv.db.about}}{{else}}...{{/if}}</p>
    </div>

    <div class="j-view-option row">
        <label class="col-xs-12 col-sm-3">{{d.l10n.keySkills}}</label>
        <p class="textarea-content col-xs-12 col-sm-9">{{#if i.userinfo.db.skill}}{{i.user_cv.db.skill}}{{else}}...{{/if}}</p>
    </div>
