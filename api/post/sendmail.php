...
if(isset($sendMailObj["is_email"])){
    ...
    if($sendMailObj) {
         if(isset($sendMailObj["smtp"])) {
            ...
            $mail->oauthUserEmail    = "no-reply@thue.today";
            ...
            // $mail->oauthRefreshToken = "1/o32RjdoNZThqDEVModT9i2saOB8ya9ajO023reYkR9I"; team@thue.today
            $mail->oauthRefreshToken = "1/-S2YAdQW_lkPwIcMTNCHZfiExwsgvrVYP8N8WNG0A8Q"; // no-reply
            $mail->Mailtype         = 'html';
            $mail->CharSet          = "UTF-8";
            $mail->Crlf             = "\r\n";
            $mail->Newline          = "\r\n";
